    ...
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px]
        ...
        <div>
          ...
          I'm <span className='text-[#915eff]'>Bernice</span></h1>

          <p className={`${styles.heroSubText} mt-2 text-white-100`}>An aspiring software 
          <br className="sm:block hidden"/> engineer and designer</p>
        </div>
